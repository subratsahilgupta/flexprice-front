...
const Overview = () => {
	...
	const handleAddSubscription = () => {
		navigate(`/customer-management/customers/subscription/${customerId}`);
	};
	...
	const {
		...
		queryKey: ['fetchSubscriptions', customerId],
	...
	return (
		<div className='space-y-6 p-6 rounded-xl border border-gray-300'>
			...
			{subscriptionsLoading ? (
				...
				<SubscriptionTable data={subscriptions as Subscription[]} />
			)}
		</div>
	);
};
