...
const OnboardingTenant = () => {
	...
	return (
		<div
			...
			<div className='absolute inset-0 bg-card/30' aria-hidden />
			<div className='relative my-8 w-full max-w-[480px] rounded-2xl bg-card p-8 shadow-lg'>
				<div className='mb-6 flex justify-center'>
					<img src={flexpriceLogo} alt={t('tenantSetup.flexpriceLogoAlt')} className='h-12' />
				</div>
				<h1 className='text-center text-2xl font-semibold text-foreground'>{t('tenantSetup.welcomeHeading')}</h1>
				<p className='mt-2 text-center text-sm text-muted-foreground'>{t('tenantSetup.welcomeSubtext')}</p>
				<div className='mt-6 space-y-4'>
					<div className='space-y-1'>
						<label className='block text-sm font-medium text-foreground' htmlFor='onboarding-org-name'>
					...
					<div className='space-y-1'>
						<label className='block text-sm font-medium text-foreground' htmlFor='onboarding-org-url'>
