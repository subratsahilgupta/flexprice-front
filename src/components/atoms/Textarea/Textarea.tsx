			...
			<div className='space-y-1 w-full flex flex-col'>
				...
				<div
					...
					<textarea
						...
						className={cn(
							'peer text-start m-0 p-0  placeholder:m-0 py-0 placeholder:py-0 placeholder:-translate-y-[6px] flex-1 bg-transparent outline-none ring-0 focus:outline-none w-full ',
