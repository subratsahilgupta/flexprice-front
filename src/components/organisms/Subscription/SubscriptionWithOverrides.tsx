	...
	return (
		<div className={`space-y-6 ${className}`}>
			...
			<div className='flex items-center justify-between'>
				<div>
					<h3 className='text-lg font-semibold text-content'>{t('organisms.subscriptionWithOverrides.chargesTitle')}</h3>
					{overridesSummary && <p className='text-sm text-content-tertiary mt-1'>{overridesSummary}</p>}
				</div>
				{hasAnyOverrides() && (
					<div className='flex items-center gap-2'>
						<Chip
							variant='warning'
							className='bg-info-muted border-info-line text-info-strong'
							label={
								getOverridesCount() > 1
				...
				<div className='bg-info-muted border border-info-line rounded-lg p-4'>
					<div className='flex items-start gap-3'>
						...
						<div className='flex-1'>
							<h4 className='font-medium text-info-deepest mb-2'>{t('organisms.subscriptionWithOverrides.priceOverridesTitle')}</h4>
