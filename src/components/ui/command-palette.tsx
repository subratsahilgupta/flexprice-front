...
>(({ className, children, ...props }, ref) => (
	<CommandPrimitive.Item
		...
		{children}
		<span
			className='ms-auto flex size-6 shrink-0 items-center justify-center rounded bg-muted p-1 shadow-sm text-muted-foreground/90 opacity-0 transition-opacity group-data-[selected=true]:opacity-100'
			aria-hidden>
