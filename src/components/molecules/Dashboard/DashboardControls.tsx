		...
		<div className='flex flex-col sm:flex-row gap-4 sm:justify-end mb-6'>
			<div className='flex flex-col sm:flex-row gap-4'>
				<div className='flex flex-col gap-2'>
					<label className={getTypographyClass('label-small', 'font-medium text-muted-foreground')}>{t('labels.timePeriod')}</label>
					<Select
						value={timePeriod}
				...
				<div className='flex flex-col gap-2'>
					<label className={getTypographyClass('label-small', 'font-medium text-muted-foreground')}>{t('labels.windowSize')}</label>
					<Select
						value={windowSize}
