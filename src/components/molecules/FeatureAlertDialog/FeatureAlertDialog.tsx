				...
				{threshold && (
					<div className='grid grid-cols-2 gap-3'>
						<div className='space-y-1'>
							<label className='text-xs font-medium text-foreground'>{t('catalog:features.alerts.thresholdValue')}</label>
							<Input
						...
						<div className='space-y-1'>
							<label className='text-xs font-medium text-foreground'>{t('catalog:features.alerts.condition')}</label>
							<Select
								options={[
