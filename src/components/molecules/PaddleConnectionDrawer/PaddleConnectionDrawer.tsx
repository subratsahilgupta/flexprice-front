			...
			<div className='space-y-6 mt-4'>
				...
				<div className='p-4 bg-info-muted border border-info-muted-foreground/20 rounded-lg'>
					...
					<div className='mb-4'>
						...
						<p className='text-xs text-info-muted-foreground mb-3'>{t('connection.paddle.webhookIntro')}</p>
					...
					<div>
						...
						{isWebhookEventsExpanded && (
							<div className='mt-2 p-3 bg-card border border-info-muted-foreground/20 rounded-md'>
								<p className='text-xs text-info-muted-foreground mb-3'>{t('connection.paddle.webhookEventsIntro')}</p>
