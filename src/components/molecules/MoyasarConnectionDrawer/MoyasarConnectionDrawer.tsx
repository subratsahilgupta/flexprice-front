			...
			<div className='space-y-6 mt-4'>
				...
				<div className='p-4 bg-info-muted border border-info-muted-foreground/20 rounded-lg'>
					...
					<div className='mb-4'>
						...
						<p className='text-xs text-info-muted-foreground mb-3'>{t('connection.moyasar.webhookIntro')}</p>
					...
					<div>
						...
						{isWebhookEventsExpanded && (
							<div className='mt-2 p-3 bg-card border border-info-muted-foreground/20 rounded-md'>
								<p className='text-xs text-info-muted-foreground mb-3'>{t('connection.moyasar.webhookEventsIntro')}</p>
								<div className='space-y-1'>
									{[t('connection.moyasar.webhookEventPaymentPaid'), t('connection.moyasar.webhookEventPaymentFailed')].map((event) => (
										<div key={event} className='flex items-center gap-2 text-xs text-info-muted-foreground'>
