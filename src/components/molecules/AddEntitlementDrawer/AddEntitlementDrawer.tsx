...
const AddEntitlementDrawer: FC<Props> = ({ isOpen, onOpenChange }) => {
                            ...
                            <div className='card p-4'>
                                <div className='flex justify-between items-start gap-4'>
                                    <FormHeader
                                        ...
                                        variant='sub-header'
                                        subtitle={activeFeature?.lookup_key}
                                    />

                                    <span className='mt-1'>
                                        {getFeatureIcon(activeFeature?.type)}
                                    </span>
                                </div>


                                {/* metered feature */}
                                {activeFeature.type === FeatureType.metered && (<div>
                                    {
                                        activeFeature.meter_id && (
                                            <div className='wf-ull flex justify-between items-center'>
                                                ...
                                                <span className='text-[#09090B] text-sm font-sans'>
                                                    {activeFeature.meter?.name}
                                                </span>
                                            </div>
                                        )
                                    }
                                    <Spacer className='!my-6' />
                                    <Input label='Value' placeholder='Enter value' suffix={
                                        <span className='text-muted-foreground text-xs font-sans'>
                                            {activeFeature.unit_plural || 'units'}
                                        </span>
                                    } />
