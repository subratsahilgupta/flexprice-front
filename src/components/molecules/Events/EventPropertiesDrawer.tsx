				...
				<div className='space-y-6 px-6 pb-6 pt-0'>
					{loading ? (
						...
						<div className='rounded-lg border border-destructive/20 bg-destructive/10 px-4 py-3'>
							<p className='text-sm font-medium text-destructive'>{t('events.debugger.loadFailedTitle')}</p>
							<p className='text-xs text-destructive mt-1'>{loadError.message || String(loadError)}</p>
						</div>
					) : debugResponse ? (
