		...
		<Sheet
			...
			<div className='space-y-6 mt-4'>
				...
				<div className='p-4 bg-surface-subtle border border-line rounded-lg'>
					...
					<p className='text-xs text-content-tertiary mb-4'>{t('connection.sync.description', { partner: CHARGEBEE_PROVIDER })}</p>
					...
					<div className='space-y-4'>
						...
						<div className='flex items-center justify-between p-3 bg-surface border border-line rounded-lg'>
							<div>
								...
								<p className='text-xs text-content-muted'>{t('connection.chargebee.pushToChargebee')}</p>
							</div>
				...
				<div className='p-4 bg-info-muted border border-info-line rounded-lg'>
					...
					<div className='mb-4'>
						...
						<p className='text-xs text-info-strong mb-3'>{t('connection.chargebee.webhookIntro')}</p>
					...
					<div>
						...
						{isWebhookEventsExpanded && (
							<div className='mt-2 p-3 bg-surface border border-info-line rounded-md'>
								<p className='text-xs text-info-strong mb-3'>{t('connection.chargebee.webhookEventsIntro')}</p>
