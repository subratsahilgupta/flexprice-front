		...
		<Sheet
			...
			<div className='space-y-6 mt-4'>
				...
				<div className='p-4 bg-info-muted border border-info-muted-foreground/20 rounded-lg'>
					...
					<p className='text-xs text-info-muted-foreground mb-4'>
					...
					<div className='mb-4'>
						...
						<p className='text-xs text-info-muted-foreground mb-3'>{t('connection.quickBooks.qbWebhookIntro')}</p>
					...
					{formData.sync_config.payment && (
						<div className='p-3 bg-card border border-info-muted-foreground/20 rounded-md'>
							<p className='text-xs text-info-muted-foreground font-medium mb-2'>{t('connection.webhook.setupInstructions')}</p>
							<ol className='text-xs text-info-muted-foreground space-y-1 list-decimal list-inside'>
					...
					<div>
						...
						{isWebhookEventsExpanded && (
							<div className='mt-2 p-3 bg-card border border-info-muted-foreground/20 rounded-md'>
								<p className='text-xs text-info-muted-foreground mb-3'>{t('connection.quickBooks.qbWebhookEventsIntro')}</p>
				...
				{!connection && (
					<div className='p-4 bg-info-muted border border-info-muted-foreground/20 rounded-lg'>
						<h3 className='text-sm font-medium text-info-muted-foreground mb-2'>{t('connection.quickBooks.oauthTitle')}</h3>
						<p className='text-xs text-info-muted-foreground mb-2'>{t('connection.quickBooks.oauthBody')}</p>
						<p className='text-xs text-info-muted-foreground mb-2'>{t('connection.quickBooks.oauthClientReady')}</p>
						<p className='text-xs text-info-muted-foreground mb-2'>
							<Trans
								ns='settings'
								i18nKey='connection.quickBooks.oauthImportantRich'
								components={{ important: <span className='text-warning font-bold' /> }}
							/>
						</p>
						<div className='flex items-center gap-2 p-2 bg-card border border-info-muted-foreground/20 rounded-md mt-2'>
