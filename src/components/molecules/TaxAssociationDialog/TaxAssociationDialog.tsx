			...
			<form onSubmit={handleSubmit} className='space-y-6'>
				<div className='space-y-4'>
					<div className='space-y-2'>
						...
						/>
						{isLoadingTaxRates && <p className='text-sm text-muted-foreground mt-1'>{t('taxAssociation.loadingTaxRates')}</p>}
					</div>
					...
					<div className='space-y-2'>
						...
						/>
						<p className='text-sm text-muted-foreground'>{t('taxAssociation.priorityHint')}</p>
					</div>
					...
					<div className='space-y-2'>
						...
						/>
						<p className='text-sm text-muted-foreground'>{t('taxAssociation.autoApplyHint')}</p>
					</div>
				</div>
