		...
		<Dialog
			...
			<div className='grid gap-4 mt-3'>
				<div className='space-y-2 !mb-6'>
					...
					/>
					{selectedCadenceDescription && <p className='text-sm text-muted-foreground'>{selectedCadenceDescription}</p>}
				</div>
				...
				{formData.cadence === CREDIT_GRANT_CADENCE.RECURRING ? (
					<div className='space-y-2'>
						...
						<p className='text-xs text-muted-foreground'>{t('creditGrant.subscriptionModal.periodEndHint')}</p>
				...
				<div className='flex flex-col items-start gap-2 w-full'>
					<label className={cn('block text-sm font-medium', 'text-foreground')}>{t('creditGrant.modal.conversionRate')}</label>
				...
				<div className='flex flex-col items-start gap-2 w-full'>
					<label className={cn('block text-sm font-medium', 'text-foreground')}>{t('creditGrant.modal.topupConversionRate')}</label>
					<div className='flex items-center gap-2 w-full'>
						<Input className='w-full' value={'1'} disabled suffix='credit' />
						<span>=</span>
						<Input
